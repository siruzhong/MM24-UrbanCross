...
def parser_options():
    ...
    parser.add_argument('-e', '--experiment_name', 
                        default='test', 
                        type=str, 
                        help="the file name of ckpt save")
    ...
    parser.add_argument('--image_path', 
                        default='./rs_data/', 
                        type=str, 
                        help="remote images data path")
    parser.add_argument('--vocab_path', default='./vocab/', type=str, help="vocab data path")
    parser.add_argument('--resnet_ckpt', 
                        default='./aid_28-rsp-resnet-50-ckpt.pth', 
                        type=str,
    ...
    parser.add_argument('--batch_size_test', default=100, type=int, help="Batch train size")
    ...
    parser.add_argument('--distributed', 
                        default=False, 
                        action='store_true',
                        help='Whether to use parallel computing')
